> **Note:** This is the original upstream Ansible `README.md`, preserved here for
> attribution after this README was replaced with documentation for the
> **unofficial native-Windows port** of ansible-core. See [`README.md`](README.md)
> for the Windows port, and the upstream project at <https://github.com/ansible/ansible>.
